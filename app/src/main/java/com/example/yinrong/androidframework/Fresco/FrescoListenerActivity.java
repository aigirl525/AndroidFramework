...
@ContentView(R.layout.activity_fresco_listener)

public class FrescoListenerActivity extends Activity {
    @ViewInject(R.id.sdv_fresco_listener)
    private SimpleDraweeView sdv_fresco_listener;
    @ViewInject(R.id.tv_fresco_listener)
    private TextView tv_fresco_listener;
    @ViewInject(R.id.tv_fresco_listener2)
    ...
    @Event(value =  R.id.bt_fresco_listener )
